...
public enum AELang implements ILangEntry {
    ...
    AE_AUTO_PROCESSING_RECIPE_CONFIG("gui", "ae_auto_processing_recipe_config.title"),
    ...
    AE_RECIPE_CONFIG_PRODUCTS_SELF_REFERENTIAL("gui", "ae_recipe_config.products_self_referential"),
    ...
    AE_RECIPE_CONFIG_ROUTE_SELF_REFERENTIAL("gui", "ae_recipe_config.route_self_referential"),
    ...
    AE_AUTO_PROCESSING_PRODUCT_FILTER_TOOLTIP("gui", "ae_auto_processing_recipe_config.product_filter.tooltip"),
