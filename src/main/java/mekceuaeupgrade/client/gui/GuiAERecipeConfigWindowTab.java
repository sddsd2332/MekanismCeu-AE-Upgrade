...
public class GuiAERecipeConfigWindowTab extends GuiWindowCreatorTab<TileEntityContainerBlock, GuiAERecipeConfigWindowTab> {
    ...
    protected void drawBackgroundOverlay() {
        ...
        GuiUtils.blit(iconX, iconY, TAB_ICON_SIZE, TAB_ICON_SIZE, 0, 0, ITEM_TEXTURE_SIZE, ITEM_TEXTURE_SIZE,
    ...
    private boolean hasWirelessUpgrade() {
        ...
        return configType == AERecipeConfigType.AUTO_PROCESSING
              ? host.hasAEWirelessAutoProcessingUpgrade() : host.hasAEWirelessCraftingUpgrade();
    }
